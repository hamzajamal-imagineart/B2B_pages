...
/**
 * Same composition as the Enterprise hero: centred eyebrow and two-tone
 * display heading, a full-width 16:9 media banner carrying a product-tour
 * lightbox, then a CTA-left / copy-right foot.
 *
 * The banner runs card-generate.mp4 rather than the Enterprise hero's
 * hero-v2.mp4 — that file is a Langdock screen recording (HANDOFF §6 item 7).
 * This one is a genuine ImagineArt capture: prompt box through to a generated
 * asset, 11.7s.
 */
const VIDEO_SRC = "/media/card-generate.mp4";
  ...
  return (
    <section id="top" className="hero-section">
      <div className="container-page hero-inner relative z-10">
        <h1 className="display hero-h1 mx-auto max-w-[18ch] text-center">
          On brand. Every asset.{" "}
          <span className="h-muted">Built for how business actually runs.</span>
        </h1>

        {/* Single full-width banner. The grain sits underneath as the fill,
            so nothing flashes white before the video paints. */}
        <div className="hero-banner grain grain-diagonal grain-mineral mt-14 md:mt-16">
          <video
        ...
        <div className="hero-foot mt-6">
          <div>
            <ButtonLink href={CONTACT_HREF} variant="brand" size="lg">
              Contact Sales
            </ButtonLink>
          </div>
          ...
          <div className="hero-foot-copy">
            <p className="hero-foot-text">
              ImagineArt is one of the best AI tools for business teams that
              need creative at scale, the speed, structure, and control to ship
              campaign-ready assets up to 90% faster and 75% more
              cost-effective. Humans and AI, built around how your operation
              actually works.
            </p>
            <a href="#industries" className="hero-link">
              Find your industry →
            </a>
          </div>
        </div>
      ...
      <style>{`
        ...
        .hero-video {
          ...
          /* Scroll-driven rather than a scroll listener: runs on the
             compositor, needs no JS, and browsers without scroll timelines
             simply render the first keyframe (scale 1). */
